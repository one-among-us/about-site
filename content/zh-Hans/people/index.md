...
people:
  '成员介绍':
    - title: 'Esme（她/she/elle）'
      details: >-
        Esme 是我们的理事。她负责 One Among Us 每年在多伦多举办的跨性别纪念日与跨性别现身日活动，
        目前也在参与要求安大略省全民医保覆盖所有人的政治倡议。她不喜欢计算机编程，也不喜欢学习数学。
        她热爱拍摄城市的日常景色和朋友们的生活瞬间，也喜欢修理老式自行车和电子产品。
    ...
    - title: 'Annie（她/she）'
      details: >-
        Annie 是 One Among Us 网站的维护者之一。她参与撰写词条，保存我们离世朋友的记忆。
        她偶尔会灵感迸发，并喜欢用创作表达这些想法。嗯，她也是一只喜欢偷偷找零食吃的流浪猫（比喻意义上）。
    ...
    - title: 'Vapaa（TA/they/she）'
      details: >-
        Vapaa 主要负责整理与分享各种信息，包括性别多元人士如何更好地完成学业、规划并在世界各地开始生活，
        以及许多其他相关领域。如果 Vapaa 没有注意到其他生物正在靠近，你也许会看到突然受到惊吓的 TA 跳起来。
    ...
    - title: 'Beiyan Shu（她/TA/she/they）'
      details: >-
        Shu 主要负责 One Among Us 在多伦多的社区服务与对外联络。她喜欢和大家待在一起。
        她不太会做饭，我们已经提醒过你不要吃她做的东西了。
...
import Page from '../../en/people/index.vue';
